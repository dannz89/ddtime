...
export class Time {
  ...
  /**
   * 
   * @param _initialTimeOrHour string or whole number representing a time. 
   * 
   ...
   * @param _initialMinutes Initial minutes-in-hour component of this 
   * Time. Valid values are 0-59. Invalid values will fail the 
   ...
   * 
   * @param _initialTimeOrHour {@link constructor}
   * @param _initialMinutes {@link constructor}
   * @param _initialSeconds Initial seconds-in-minute component of 
   * this Time. Valid values are 0-59. Invalid values will fail the 
   * validation check, set this Time's isValid to false and populate
   * the _validationMessage string.
   */
   ...
   * Valid values are 0-999. Invalid values will fail the 
   * validation check, set this Time's isValid to false and populate
   * the _validationMessage string.
   */
